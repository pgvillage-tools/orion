...
const (
	...
	KeeperLabelValue ComponentLabelValue = "orion-keeper"
	// SentinelLabelValue states the pod to be a sentinel pod
	SentinelLabelValue ComponentLabelValue = "orion-sentinel"
	// ProxyLabelValue states the pod to be a Proxy pod
	ProxyLabelValue ComponentLabelValue = "orion-proxy"
)
...
// KubeElection takes care of the election proces for orion on k8s
...
func NewKubeElection(
	...
	rl, err := resourcelock.New("configmaps",
		...
		resourcelock.ResourceLockConfig{
			...
			EventRecorder: createRecorder(kubecli, "orion-sentinel", namespace),
		})
