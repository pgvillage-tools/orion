...
func (m *MockStore) AtomicPutClusterData(ctx context.Context, cd *cluster.Data, previous *consensus.KVPair) (*consensus.KVPair, error) {
...
func (m *MockStore) GetClusterData(ctx context.Context) (*cluster.Data, *consensus.KVPair, error) {
